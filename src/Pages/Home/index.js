    ...
    return(
      <View style={styles.container}>
        <View style={styles.body}>
          <TextInput style={{width:'80%',borderWidth:1,borderColor:'#000',alignSelf:'flex-start',marginLeft:8}} 
        ...
        onEndEditing={(usuario) => this.pesquisarUsuario(usuario)}/>
            <View style={styles.infosUsuario}>
                <Image style={{width:'20%', height:'60%',padding:10,borderRadius:responsiveWidth(10)}} 
                resizeMode="contain"
                source={{uri:this.props.repositories.data.ownerAvatarUrl}}
                />
                <Text style={{padding:10,fontSize:responsiveFontSize(1.8),fontWeight:'bold',color:'#000'}}>{this.props.repositories.data.txtQtdRepositorio}</Text>
            </View>
            <Text style={{fontWeight:'bold',fontSize:responsiveFontSize(3),alignSelf:'flex-start',paddingLeft:10,color:'#000'}}>{this.props.repositories.data.txtRepositorioDe}</Text>
        ...
        <Loader loading={this.props.repositories.data.isLoading} message='Procurando...'/>
            </View>
      </View>
    )
  }
